...
document.addEventListener("DOMContentLoaded", () => {
  ...
  llenarSelect(); // Muestra el campo año
});

// Even listener para select de busqueda
...
function llenarSelect() {
  for (let i = max; i > min; i--) {
    ...
    year.appendChild(opcion); // Agregando los años al select
  }
}

// Filtra segun la busqueda
function filtrarAuto() {
  ...
  if (resultado.length) {
    ...
    console.log("Si hay resultado");
  } else {
    noResultado();
    console.log("No encontraron resultado");
  }
}
